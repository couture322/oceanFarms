...
## Figure 3: Equilibrium biomass and catches with positive and negative impacts to wild populations
...
szMgmtBen<-read_csv("runs/aqMS/farmEq_mpaMgmtAMBen.csv")
...
szMgmtNeg<-read_csv("runs/aqMS/farmEq_mpaMgmtAMNeg.csv")
