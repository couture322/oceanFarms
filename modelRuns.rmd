...
### one large area - OA
msAttrOA_20<-msAttPlFun(mpaSzVec = seq(0.05,0.2,by=0.05),
                     attrVec = c(1,3,9,15), 
                     pK=ptchKp,
                     farmYrsVec=rep(TRUE,length(mpaYr:sYrs)),
                     farmSz = NA,
...
### several smaller areas - OA
msAttrOAxs_20<-msAttPlFun(mpaSzVec = seq(0.05,0.2,by=0.05),
                     attrVec = c(1,3,9,15), 
                     pK=ptchKp,
                     farmYrsVec=rep(TRUE,length(mpaYr:sYrs)),
                     farmSz=5, #this divides the farm area into farms of size 10
...
### one large area - CE
msAttrCE_20<-msAttPlFun(mpaSzVec = seq(0.05,0.2,by=0.05),
                     attrVec = c(1,3,9,15), 
                     pK=ptchKp,
                     farmYrsVec=rep(TRUE,length(mpaYr:sYrs)),
                     farmSz = NA,
...
### several small areas - CE
msAttrCExs_20<-msAttPlFun(mpaSzVec = seq(0.05,0.2,by=0.05),
                     attrVec = c(1,3,9,15), 
                     pK=ptchKp,
                     farmYrsVec=rep(TRUE,length(mpaYr:sYrs)),
                     farmSz = 5,
...
# write_csv(msAttrOA_20,"runs/openAccess/farmEq_msAttOALg_20.csv")
# write_csv(msAttrOAxs_20,"runs/openAccess/farmEq_msAttOAXSm_20.csv")
# 
# write_csv(msAttrCE_20,"runs/constantEffortMSY/farmEq_msAttCELg_20.csv")
# write_csv(msAttrCExs_20,"runs/constantEffortMSY/farmEq_msAttCEXSm_20.csv")
...
mpaMgmtAMBen_20<-mpaMgmtAMPlFunMat(mpaSzVec=seq(0.05,0.2,by=0.05),
                  attr = 5,
                  amVec= c(0,3,20,60),
                  pK=ptchKp,
                  farmSz = 5,
...
mpaMgmtAMNeg_20<-mpaMgmtAMPlFunMat(mpaSzVec=seq(0.05,0.2,by=0.05),
                  attr = 5,
                  amVec= c(0,3,20,60),
                  farmSz = 5,
                  pK = ptchKp,
...
mpaMgmtAMInert_20<-mpaMgmtAMPlFunMat(mpaSzVec=seq(0.05,0.2,by=0.05),
                  attr = 5,
                  amVec= c(0,3,20,60),
                  farmSz = 5,
                  pK = ptchKp,
                  mImp = 1, ## damage bc increases nat mort
                  farmYrsVec=rep(TRUE,length(mpaYr:sYrs))) 
# write_csv(mpaMgmtAMBen_20,"runs/movement/farmEq_mpaMgmtAMBen_20.csv")
# write_csv(mpaMgmtAMNeg_20,"runs/movement/farmEq_mpaMgmtAMNeg_20.csv")
write_csv(mpaMgmtAMInert_20,"runs/movement/farmEq_mpaMgmtAM0_20.csv")
