...
### adult movement & farm size - OA (weak management)
...
### adult movement & farm size - CE (strong management)
amFsCEmBen<-amFsPlFunMat(amVec = seq(0,80,by=20),
                  farmSizeVec = c(1,2,5,10,20),
                  mpaSz = 0.2,
                  attr = 5,
                  pK=ptchKp,
...
amFsCEmNeg<-amFsPlFunMat(amVec = seq(0,80,by=20),
                  farmSizeVec = c(1,2,5,10,20),
                  mpaSz = 0.2,
                  attr = 5,
                  pK=ptchKp,
...
# write_csv(amFsOAmBen,"runs/openAccess/farmEq_amFsBen.csv")
# write_csv(amFsOAmNeg,"runs/openAccess/farmEq_amFsNeg.csv")
# write_csv(amFsCEmBen,"runs/openAccess/farmEq_amFsBenCE.csv")
# write_csv(amFsCEmNeg,"runs/openAccess/farmEq_amFsNegCE.csv")

```

```{r}

### High mortality: natural mortality at farms > fishing mortality
